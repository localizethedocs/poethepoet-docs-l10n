...
if     (VERSION_OF_POETRY_EXPORT STREQUAL "[none]")
    set(PACKAGE_OF_POETRY_EXPORT "")
elseif (VERSION_OF_POETRY_EXPORT STREQUAL "")
    set(PACKAGE_OF_POETRY_EXPORT "conda-forge::poetry-plugin-export")
else()
    set(PACKAGE_OF_POETRY_EXPORT "conda-forge::poetry-plugin-export=${VERSION_OF_POETRY_EXPORT}")
endif()
remove_cmake_message_indent()
message("")
execute_process(
